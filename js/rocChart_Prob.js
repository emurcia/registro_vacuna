function rocChart(id, data, options) {
  ...
  var color = d3.scale.ordinal().range(["grey", "green", "purple"]);
  ...
  function drawAUCText(auc, tpr, label) {
    ...
    svg.append("g")
      .attr("class", tpr + "text")
      .style("opacity", 0)
      .attr("transform", "translate(" + .3*width + "," + .85*height + ")")
      .append("text")
        .text(label)
        .style({
          "fill": "white",
    ...
    svg.append("g")
      .attr("class", tpr + "text")
      .style("opacity", 0)
      .attr("transform", "translate(" + .3*width + "," + .94*height + ")")
      .append("text")
